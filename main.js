...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction tabMenu(tabcontent) {\n\ttabcontent.innerHTML = `\n\t<h1>THIS OUR MENU BITCH</h1>\n\t<dl>\n\t\t<dt>Sushi</dt>\n\t\t<dd>Great mix of sushi things rolled up into a sushi.</dd>\n\t\t<dd>15USD</dd>\n\n\t\t<dt>Tacos</dt>\n\t\t<dd>Superb mix of taco things rolled up into a taco.</dd>\t\n\t\t<dd>12USD</dd>\t\n\n\t\t<dt>Sandwich</dt>\n\t\t<dd>Amazing mix of sandwich things rolled up into a sandwich?</dd>\n\t\t<dd>8USD</dd>\n\t</dl>\n\t`;\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (tabMenu);\n\n//# sourceURL=webpack:///./src/tabMenu.js?");
